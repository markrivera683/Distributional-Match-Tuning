...
# ============================================================
# G2 Baseline Rerun — 8×A100, cf_l1oo + remote teacher target, ~500 global steps
# Uses remote-teacher target distribution config for rerun
...
# gpu: 8xA100
# target completion: GT + remote teacher mixed target distribution
# eval: null
...
# ---- G2 Core: cf_l1oo reward + remote teacher target ----
...
# ---- Output ----
GLOBAL_SEED=43
RUN_TAG="g2_baseline_8gpu_rerun_$(date +%Y%m%d_%H%M%S)"
...
echo "============================================================"
echo "[$(date -u '+%Y-%m-%d %H:%M:%S UTC')] G2 Baseline Rerun"
echo "============================================================"
...
echo "[$(date -u '+%Y-%m-%d %H:%M:%S UTC')] G2 Baseline Rerun finished"
