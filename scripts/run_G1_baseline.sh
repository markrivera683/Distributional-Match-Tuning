...
# ╔══════════════════════════════════════════════════════════════════╗
# ║  G1: Paper-faithful Baseline — 8×A100                          ║
# ║  pointwise reward · frozen critic · no teacher                 ║
# ╚══════════════════════════════════════════════════════════════════╝
#
# Target measure:  nu_c = δ(GT)   (single GT point, no teacher)
# Reward:          pointwise alignment/diversity
# Critic:          fully frozen (LR = 0)
#
# Contrast pair:   scripts/run_g2_8gpu_remote_teacher.sh
#   The ONLY intended difference vs G2 is:
#     G1: distribution_reward_type=pointwise, no teacher
#     G2: distribution_reward_type=cf_l1oo,   cf_target_mode=teacher
#
# Usage:
#   bash scripts/run_G1_baseline.sh
#
# Override any variable via env, e.g.:
#   MAX_SAMPLES=10000 bash scripts/run_G1_baseline.sh
...
# No feature adapter for G1
# (feature_adapter_enable not passed → defaults to False)

# ====================================================================
# 3. REWARD FUNCTION (pointwise alignment/diversity)
# ====================================================================
...
# ====================================================================
# 5. TRAINING BUDGET & BATCH SIZES  (aligned with G2)
# ====================================================================
...
# ====================================================================
# 6. LOSS COEFFICIENTS & OPTIMIZER  (aligned with G2)
# ====================================================================
...
# ====================================================================
RUN_TAG="G1_baseline_$(date +%Y%m%d_%H%M%S)"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  G1: Paper-faithful Baseline (pointwise, no teacher)        ║"
echo "╚══════════════════════════════════════════════════════════════╝"
...
echo ""
echo "  [Reward]"
echo "    Reward type:       ${DISTRIBUTION_REWARD_TYPE}  (pointwise — no CF, no teacher)"
echo "    Target mode:       ${CF_TARGET_MODE}"
echo "    Critic LR:         ${CRITIC_LR}  (frozen)"
echo ""
