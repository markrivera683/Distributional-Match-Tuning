...
#   supplement_2rounds/G3.sh, FIRST_PASS_MAX_NEW_TOKENS=16384 / 32768)
...
POST_EVAL_SCRIPT="${POST_EVAL_SCRIPT:-${REPO_ROOT}/scripts/supplement_2rounds/G3_2node.sh}"
