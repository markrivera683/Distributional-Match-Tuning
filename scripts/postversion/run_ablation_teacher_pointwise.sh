...
# ╔══════════════════════════════════════════════════════════════════╗
# ║  Ablation C: Teacher + Pointwise                                ║
# ║  fixed remote teacher · pointwise reward only                   ║
# ╚══════════════════════════════════════════════════════════════════╝
#
# Goal: clean distribution-matching ablation with a fixed teacher.
# This script is intentionally kept identical to
#   scripts/postversion/run_ablation_teacher_cf.sh
...
# - CF_* values are also declared identically here for reviewer parity, but this
#   pointwise script intentionally does not forward any --cf_* CLI arguments.
...
# 4. REWARD CONFIG
# ====================================================================
# Shared non-CF feature-map config (kept identical to the CF baseline).
...
# Shared CF baseline values (declared for parity; NOT passed in this script).
...
# UNIQUE DIFF 1/2: pointwise reward only (G1-style alignment + diversity).
DISTRIBUTION_REWARD_TYPE="${DISTRIBUTION_REWARD_TYPE:-pointwise}"

# UNIQUE DIFF 2/2: disable all --cf_* parameters for this ablation.
CF_ARGS=()
CF_ARGS_ENABLED="false"
...
# ====================================================================
ABLATION_NAME="ablation_teacher_pointwise"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  Ablation C: teacher + pointwise                            ║"
echo "╚══════════════════════════════════════════════════════════════╝"
