...
# Smoketest for the G2 multi-worker teacher setup.
...
OUTPUT_ROOT="${OUTPUT_ROOT:-/root/outputs/smoketest_G2_multiworker}"
RUN_NAME="${RUN_NAME:-g2_smoke_$(date +%m%d_%H%M%S)}"
...
echo "=============================================="
echo "  G2 Multi-Worker Teacher Smoketest"
echo "=============================================="
...
if [[ ! -f "${BENCH_SCRIPT}" ]]; then
  ...
  echo ""
  echo "[DONE] G2 smoketest — Phase 1 passed, Phase 2 skipped."
  exit 0
fi
...
echo ""
echo "=============================================="
echo "  G2 Multi-Worker Smoketest PASSED"
echo "  Logs: ${RUN_DIR}"
echo "=============================================="
