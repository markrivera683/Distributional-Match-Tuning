#!/usr/bin/env bash
# ╔══════════════════════════════════════════════════════════════════╗
# ║  G2 Rebase — no-teacher vicinal distribution                    ║
# ║  cf_l1oo reward · vicinal target · reuse all 8 GPUs            ║
# ╚══════════════════════════════════════════════════════════════════╝
#
# CONTROLLED VARIABLES vs scripts/run_G2_rebase.sh:
...
#
# CONTROLLED VARIABLES vs scripts/run_G1_rebase.sh:
#   - keep no-teacher training path
#   - switch distribution_reward_type: pointwise -> cf_l1oo
#   - switch cf_target_mode: single -> vicinal
#   - keep G2-style training / eval budget
#
# Usage:
...
# --------------------------------------------------------------------
# 2) TRAINING KNOBS — G2 budget, no-teacher vicinal target
# --------------------------------------------------------------------
...
EVAL_AFTER_TRAIN="${EVAL_AFTER_TRAIN:-false}"
...
echo "──────────────────────────────────────────────────"
echo "G2 no-teacher vicinal run completed at $(date)" > "${RUN_DIR}/status.txt"
