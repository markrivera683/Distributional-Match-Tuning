#!/usr/bin/env bash
# G1 Formal - 真正的 8 卡训练: actor=4, critic=4, 无 colocate_all_models
# FIX: 添加 --eval_steps 10 确保 trainer 有 GPU 资源
set -euo pipefail
...
# G1 Formal: pointwise, 4+4 拓扑，显式所有关键参数
# FIX: eval_steps=10 确保 trainer_needs_gpu=True
