...
# Group 2: Dist-Only (仅加入 distribution matching)
...
# Run Configuration
RUN_TAG="aops_g2_distonly_seed${GLOBAL_SEED}"
...
echo "[$(date -u '+%Y-%m-%d %H:%M:%S UTC')] Starting AoPS Group 2: Dist-Only"
...
echo "[$(date -u '+%Y-%m-%d %H:%M:%S UTC')] Group 2 Dist-Only finished"
